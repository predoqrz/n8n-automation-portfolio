...
**Onde eu parei:** etapa 5 — página criada no Notion; testando log no Postgres e marcador no Gmail
...
- [ ] Fixar (pin) a saída do nó do Notion antes de testar os nós seguintes
